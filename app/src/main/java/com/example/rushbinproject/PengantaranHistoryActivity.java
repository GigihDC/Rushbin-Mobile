...
public class PengantaranHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengantaran_history);
    ...
    private void getData() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, DbContract.URL_GET_DATA_ANTAR, null,
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        String data = "ID Pengantaran: " + jsonObject.getString("id_pengantaran") + "\n" +
                ...
                VolleySingleton.getInstance(PengantaranHistoryActivity.this).addToRequestQueue(jsonObjectRequest);
            }
        }, PROGRESS_DELAY);
    }
}
